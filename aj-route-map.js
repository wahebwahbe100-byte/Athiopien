...
const ROUTES={
 ...
 harar:{label:'Harar & Ostäthiopien',arrowRepeat:'52px',stops:[stop('Addis Abeba','addis','Start & Flug'),stop('Dire Dawa','diredawa','Ankunft per Inlandsflug'),stop('Harar','harar','UNESCO-Altstadt'),stop('Babile','babile','Elefantengebiet & Kamelmarkt'),stop('Harar','harar','Rückkehr'),stop('Dire Dawa','diredawa','Rückflug'),stop('Addis Abeba','addis','Ende')]},
