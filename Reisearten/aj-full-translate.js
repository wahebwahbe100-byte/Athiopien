...
(function(){
  ...
  const NAV_I18N = {
    ...
    ru:{groups:'Групповые туры',private:'Индивидуальные туры',modules:'Конструктор тура',tips:'Советы туристам',info:'Информация',builder:'Спланировать',login:'Войти',home:'Эфиопия'},
    ...
    el:{groups:'Ομαδικά ταξίδια',private:'Ιδιωτικά ταξίδια',modules:'Σχεδιασμός ταξιδιού',tips:'Ταξιδιωτικές συμβουλές',info:'Πληροφορίες',builder:'Σχεδιάστε',login:'Σύνδεση',home:'Αιθιοπία'},
